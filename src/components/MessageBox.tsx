...
export default function MessageBox() {
  ...
  return !sent ? (
    <div className="shadow-lg p-5 rounded-xl bg-pallete-1 text-pallete-4 mt-5">
      ...
      {!loading ? (
        ...
        <div role="status" className="flex justify-center mt-3">
          <svg
            aria-hidden="true"
            className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-pallete-2 fill-pallete-4"
            viewBox="0 0 100 101"
            fill="none"
    ...
    <h5 className="text-2xl text-center text-pallete-2 mt-3">message sent.</h5>
  );
}
